...
public class YearlyReportPanel extends JPanel implements ItemListener
{

	/**
	 * 
	 */
	private static final long serialVersionUID = 1861252753508865317L;
	String selectedYr = null;
	List<Order> orderList = null;
	JFrame jFrame;
	public YearlyReportPanel(String selectedRowString,JFrame jFrame)
	{
		this.selectedYr = selectedRowString;
		this.jFrame = jFrame;
		buildGUI();
	}
	MonthlyFrame monthlyFrame;
	public YearlyReportPanel()
	{
		buildGUI();	
	...
	public void buildGUI()
	{
		...
		this.setBorder(BorderFactory.createCompoundBorder(
					BorderFactory
					.createTitledBorder("Report of year " + selectedYr),
			BorderFactory.createEmptyBorder(20, 20, 20, 20)));
			
		try 
		{
			orderList = Report.retrieveDataForYearlyReport(selectedYr,null,null);
		} 
	...
	public void itemStateChanged(ItemEvent e) 
	{
	    if(e.getStateChange() == ItemEvent.SELECTED)
		{
	    	...
	    	reportRequest.setYear(this.selectedYr);
