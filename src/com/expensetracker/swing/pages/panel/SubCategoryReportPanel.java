...
public class SubCategoryReportPanel extends JPanel implements ItemListener
{
	...
	public SubCategoryReportPanel(ReportRequest reportRequest,JFrame jFrame)
	{
	...
	public void buildGUI()
	{
		...
		this.setBorder(BorderFactory.createCompoundBorder(
					BorderFactory
					.createTitledBorder("Report of SubCateogry " + reportRequest.getSubcategory()),
			BorderFactory.createEmptyBorder(20, 20, 20, 20)));
			
		try 
		{
			orderList = Report.retrieveDataForSubCategoryYearlyReport(reportRequest);
		} 
	...
	public class MyTableModel implements TableModel
	{
		...
		private String[] columnNames={"Order Date","Category","Sub-Category","Product","Brand","Shop Name","Quantity","Price"};
